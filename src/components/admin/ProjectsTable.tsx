            ...
            <tbody>
              {filtered.map((project) => (
                ...
                >
                  ...
                  <td className="px-5 py-3">
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs ${project.published ? "bg-green-500/10 text-green-400 border border-green-500/20" : "bg-gray-700/50 text-gray-500 border border-gray-700"}`}
                    >
