...
import { Mail, Github, Linkedin, Globe, Phone, Code2, ExternalLink } from 'lucide-react'
        ...
        <div className="max-w-2xl mx-auto">
          <div className="grid sm:grid-cols-2 gap-4">
            {contacts.map((contact, i) => {
              ...
              const href = contact.url ?? (contact.type === 'email' ? `mailto:${contact.value}` : contact.value)
          ...
          {!contacts.length && (
            <div className="text-center py-10 text-gray-600">No contact info added yet.</div>
          )}
        </div>
      </div>
    </section>
