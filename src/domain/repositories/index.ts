import { Project, Skill, Certificate, Service, Contact, Profile, ProjectCategory } from '../entities'
...
export interface IProjectRepository {
  ...
  upsertFromGithub(data: Omit<Project, 'id' | 'createdAt' | 'updatedAt'>): Promise<Project>
}
